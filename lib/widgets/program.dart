...
class program_1 extends StatelessWidget {
  
  final bool isVisible;
  
  const program_1({Key? key , required this.isVisible}) : super(key: key) ;
      ...
      SizedBox(
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Text("Sabah\n\n 1 kutu peynir, 1 dilim ekmek , 1 yumurta",
        ...
        child: Card(
          ...
          child: Padding(
            padding:  EdgeInsets.all(45.0),
            child: Text("Öğle\n\n 1 dilim ekmek, 1 porsiyon salata ",
            style: TextStyle(color: mainHexColor,fontSize: 20), 
            textAlign: TextAlign.center,
            ),
          ),
        ...
        child: Card(
          ...
          child: Padding(
            padding:  EdgeInsets.all(45.0),
            child: Text("Akşam\n\n 1 kase çorba, 1 dilim ekmek , 1 tabak tavuk pilav",
            style: TextStyle(color: mainHexColor,fontSize: 20), 
            textAlign: TextAlign.center,
            ),
          ),
